...
<nav class="bg-gray-800/100">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-dosen.nav-link href="{{ route('kepala-lab.dashboard', $currentLab->id) }}" 
              :active="request()->routeIs('kepala-lab.dashboard')">Dashboard</x-dosen.nav-link>

              <x-dosen.nav-link href="{{ route('kepala-lab.risk-assessment.index', $currentLab->id) }}" 
              :active="request()->routeIs('kepala-lab.risk-assessment.index')">Risk Assessment</x-dosen.nav-link>
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        ...
        <x-dosen.nav-link-mob href="{{ route('kepala-lab.dashboard', $currentLab->id) }}" 
        :active="request()->routeIs('kepala-lab.dashboard')">Dashboard</x-dosen.nav-link-mob>

        <x-dosen.nav-link-mob href="{{ route('kepala-lab.risk-assessment.index', $currentLab->id) }}" 
        :active="request()->routeIs('kepala-lab.risk-assessment.index')">Risk Assessment</x-dosen.nav-link-mob>

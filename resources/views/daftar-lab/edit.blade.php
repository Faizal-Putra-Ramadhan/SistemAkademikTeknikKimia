...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.daftar-lab.update', $lab) }}" method="POST">
                @csrf @method('PUT')
                <div class="form-grid">
                    <div class="form-group">
                        <label for="Nama_Laboratorium" class="form-label">Nama Laboratorium <span class="required">*</span></label>
                        <input type="text" id="Nama_Laboratorium" name="Nama_Laboratorium" class="form-control" value="{{ old('Nama_Laboratorium', $lab->Nama_Laboratorium) }}" placeholder="Lab Teknik Informatika" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="floor" name="floor" class="form-control" value="{{ old('floor', $lab->floor) }}" placeholder="Lt 2" required>
                    ...
                    <div class="form-group">
                        ...
                        <select name="lab_type" id="lab_type" class="form-control" required>
                            ...
                            @foreach($labTypes as $labType)
                                <option value="{{ $labType }}" {{ old('lab_type', $lab->lab_type) == $labType ? 'selected' : '' }}>
                                    {{ ucfirst($labType) }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select name="Kepala_Labolatorium" id="Kepala_Labolatorium" class="form-control" required>
                            ...
                            @foreach($kepalaLabList as $kepalaLab)
                                <option value="{{ $kepalaLab->Nama }}" {{ old('Kepala_Labolatorium', $lab->Kepala_Labolatorium) == $kepalaLab->Nama ? 'selected' : '' }}>
                                    {{ $kepalaLab->Nama }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="Admin_Laboratorium" name="Admin_Laboratorium" class="form-control" value="{{ old('Admin_Laboratorium', $lab->Admin_Labolatorium) }}" required>
                    ...
                    <div class="form-group" style="grid-column: 1 / -1;">
                        ...
                        <input type="email" id="email_lab" name="email_lab" class="form-control" value="{{ old('email_lab', $lab->email_lab) }}" placeholder="lab@informatika.uad.ac.id">

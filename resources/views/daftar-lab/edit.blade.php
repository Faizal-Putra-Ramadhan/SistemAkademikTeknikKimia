    ...
    <div class="container">
        ...
        <div class="main-content" id="mainContent">
            <div class="form-container">
                <h2>Edit Laboratorium Baru</h2>

                @if(session('success'))
                    <div class="success-message">{{ session('success') }}</div>
                @endif

                <form action="{{ route('daftar-lab.update', $lab) }}" method="POST">
                    @csrf @method('PUT')
                    <div class="grid-2">
                        <div class="form-group">
                            <label>Nama Laboratorium <span style="color:red">*</span></label>
                            <input type="text" name="Nama_Laboratorium" value="{{ old('Nama_Laboratorium', $lab->Nama_Laboratorium) }}" required placeholder="Lab Teknik Informatika">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="Kepala_Labolatorium" value="{{ old('Kepala_Labolatorium', $lab->Kepala_Labolatorium) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="Admin_Laboratorium" value="{{ old('Admin_Laboratorium', $lab->Admin_Labolatorium) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="Safety_Officer" value="{{ old('Safety_Officer', $lab->Safety_Officer) }}" required>
                        ...
                        <div class="form-group grid-full">
                            ...
                            <input type="email" name="email_lab" value="{{ old('email_lab', $lab->email_lab) }}" required placeholder="lab@informatika.uad.ac.id">

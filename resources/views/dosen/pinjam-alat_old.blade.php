...
<body>
    <div class="container">
        ...
        <div class="alert alert-error">
            Belum ada alat yang tersedia di laboratorium ini.
        </div>
        <div class="btn-group">
            <a href="{{ route('dosen.lab') }}" class="btn btn-secondary">Kembali</a>
        </div>
        @else
        ...
        <div id="form-container">
            <form action="{{ route('dosen.pinjam-alat.store', $lab->id) }}" method="POST">
                @csrf
                ...
                <div class="btn-group">
                    <a href="{{ route('dosen.lab') }}" class="btn btn-secondary">Batal</a>

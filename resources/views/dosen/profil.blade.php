...
<script src="https://cdn.jsdelivr.net/npm/@tailwindplus/elements@1" type="module"></script>
    ...
    <div class="min-h-full">
        ...
        <x-dosen.header>Ubah Profil</x-dosen.header>
    
    <div class="container">
        <a href="{{ route('dosen.dashboard1') }}" class="back-btn">← Kembali ke Dashboard</a>
        ...
        <div class="card">
            ...
            <form action="{{ route('dosen.profil1.update') }}" method="POST" enctype="multipart/form-data">
                @csrf

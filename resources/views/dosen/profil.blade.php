...
@section('content')
    <div class="profile-page">
        <div class="profile-top">
            <a href="{{ route('dosen.dashboard') }}" class="profile-back">← Kembali ke Dashboard</a>
        </div>
        ...
        <div class="profile-shell">
            ...
            <div class="profile-body">
                ...
                <form action="{{ route('dosen.profil.update') }}" method="POST" enctype="multipart/form-data" class="profile-form">
                    @csrf

...
@section('content')
    <div class="profile-page">
        <div class="profile-top">
            <a href="{{ route('kepala-lab.dashboard') }}" class="profile-back">← Kembali ke Dashboard</a>
        </div>
        ...
        <div class="profile-shell">
            ...
            <div class="profile-body">
                ...
                <form action="{{ route('kepala-lab.profil.update') }}" method="POST" enctype="multipart/form-data" class="profile-form">
                    @csrf

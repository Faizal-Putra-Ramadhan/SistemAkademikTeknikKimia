...
@section('page-title', 'Lihat Aktivitas')
...
@section('content')
    @if(isset($labNotFound) && $labNotFound)
        <div class="empty-state">
            <p>Laboratorium tidak ditemukan. Silakan pilih laboratorium yang tersedia atau hubungi admin.</p>
        </div>
        @return
    @endif
<!-- Peminjaman Ruangan -->
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->daftarLab->Nama_Laboratorium ?? $item->alatLab->daftarLab->Nama_Laboratorium ?? '-' }}</td>
                        <td>
                            @if($item->riskAssessment)
                                <span style="background: #e3f2fd; color: #1976d2; padding: 0.25rem 0.75rem; border-radius: 12px; font-size: 0.875rem; font-weight: 600;">

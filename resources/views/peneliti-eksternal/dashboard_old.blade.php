...
<body>
    ...
    <div class="container">
        ...
        <div class="menu-grid">
            <a href="{{ route('peneliti-eksternal.pengumuman') }}" class="menu-card">
                <div class="icon">📢</div>
                <h3>Pengumuman</h3>
            ...
            <div class="labs-grid">
                ...
                <div class="lab-card">
                    ...
                    <div class="lab-actions">
                        <a href="{{ route('peneliti-eksternal.lab.detail', $lab->id) }}" class="btn btn-primary">
                            Lihat Alat
                        </a>
                        <a href="{{ route('peneliti-eksternal.pinjam-ruangan', $lab->id) }}" class="btn btn-success">
                            Pinjam Ruangan
                        </a>
                        <a href="{{ route('peneliti-eksternal.pinjam-alat', $lab->id) }}" class="btn btn-info">
                            Pinjam Alat
                        </a>
                        <a href="{{ route('peneliti-eksternal.pengajuan-penelitian', $lab->id) }}" class="btn btn-warning">
                            Ajukan Penelitian
                        </a>
                    </div>
                    <a href="{{ route('peneliti-eksternal.aktivitas', $lab->id) }}" class="btn btn-primary" style="margin-top: 0.5rem; display: block;">

        ...
        <div class="modal-body">
            <form method="POST" id="form-peminjaman">
                ...
                <div class="modal-lab-info">
                    ...
                    <p><strong>Email Lab:</strong> <span id="modal-lab-email">-</span></p>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="modal_tanggal_selesai" name="tanggal_selesai" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="modal_keperluan">Keperluan *</label>
                    <textarea class="form-control" id="modal_keperluan" name="keperluan" required></textarea>
                </div>
                <div class="btn-group" style="margin-top:1.5rem;display:flex;gap:1rem;">
                    <button type="button" onclick="closeModal()" class="btn btn-secondary" style="flex:1;">Batal</button>
                    <button type="submit" class="btn btn-primary" style="flex:1;">Ajukan Peminjaman</button>
                </div>
            </form>
        </div>
    </div>
...
@section('page-title', 'Pinjam Ruangan')
                                ...
                                <select id="lab_select" onchange="selectLabDropdown()" required>
                                    ...
                                    @foreach($labs as $labItem)
                                        <option value="{{ $labItem->id }}" 
                                            ...
                                            {{ $labItem->Nama_Laboratorium }} - Lt. {{ $labItem->floor }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div style="background: white; padding: 2rem; border-radius: 20px; box-shadow: 0 10px 40px rgba(0,0,0,0.08);">
                                ...
                                <div class="lab-grid">
                                    ...
                                    <div class="lab-card" 
                                        ...
                                        <div class="lab-body">
                                            <h3>{{ $labItem->Nama_Laboratorium }} - Lt. {{ $labItem->floor }}</h3>
                                            <div class="lab-info">
                                                <span>👨‍🔬</span>
...
let selectedLabId = null;
        ...
        function openModal(labId, labNama, labKepala, labEmail) {
            ...
            form.action = `/peneliti-eksternal/lab/${labId}/pinjam-ruangan`;

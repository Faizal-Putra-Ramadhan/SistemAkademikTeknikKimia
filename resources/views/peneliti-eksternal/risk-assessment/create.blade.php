...
@section('page-title', 'Buat Risk Assessment')
...
<!-- BREADCRUMB -->
            ...
            <form action="{{ route('peneliti-eksternal.risk-assessment.store', $lab->id) }}" method="POST" enctype="multipart/form-data" id="raForm">
                @csrf

                <!-- SECTION 1: Data peneliti-eksternal -->
                <div class="form-section">
                    <h3> Data peneliti-eksternal</h3>
                    ...
                    <div class="form-group">
                        ...
                        <select name="laboratorium_id" id="laboratorium_id" class="form-control" required>
                            ...
                            @foreach($daftar_labs as $labItem)
                                <option value="{{ $labItem->id }}"
                                    {{ old('laboratorium_id', $lab->id) == $labItem->id ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <div class="checkbox-group">
                                    <div class="checkbox-item">
                                        ...
                                        <label for="exp_0"> Explosive</label>
                                    </div>
                                    <div class="checkbox-item">
                ...
                <div class="form-section">
                    <h3> Pernyataan peneliti-eksternal</h3>
                ...
                <div class="btn-group">
                    ...
                    <a href="{{ route('peneliti-eksternal.risk-assessment.index') }}" class="btn-secondary"> Batal</a>
                </div>

@extends('layouts.app')
@section('title', 'Profil Safety Officer')
...
@section('content')
    <div class="profile-page">
        <div class="profile-top">
            <a href="{{ route('safety-officer.dashboard') }}" class="profile-back">← Kembali ke Dashboard</a>
        </div>
        ...
        <div class="profile-shell">
            ...
            <div class="profile-body">
                ...
                <form action="{{ route('safety-officer.profil.update') }}" method="POST" enctype="multipart/form-data" class="profile-form">
                    @csrf
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-field">
                            ...
                            <input type="text" class="profile-input" id="Phone" name="Phone" required value="{{ old('Phone', $user->Phone) }}">
                            @error('Phone')
                                <div class="form-error">{{ $message }}</div>
                            @enderror
                        </div>

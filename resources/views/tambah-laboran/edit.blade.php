...
@section('page-title', 'Edit Data Laboran')
...
@section('content')
    ...
    <div class="alert-box info">
        ...
        <span><strong>Info:</strong> Akun ini adalah akses khusus Laboran.</span>
    </div>

    <div class="card">
        <div class="card-header">
            <h3>Edit Data Laboran</h3>
            <span class="badge badge-info">{{ $laboran->UserID }}</span>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.tambah-laboran.update', $laboran->id) }}" method="POST">
                @csrf
                @method('PUT')

                <div class="form-grid">
                    <div class="form-group">
                        <label for="UserID" class="form-label">User ID (Otomatis)</label>
                        <input type="text" id="UserID" class="form-control readonly-field"
                               value="{{ $laboran->UserID }}" disabled>
                        <p class="form-hint">User ID dibuat otomatis dan akan diperbarui jika role berubah</p>
                    </div>
                            ...
                            @forelse($daftar_labs as $lab)
                                <label style="display: flex; align-items: center; gap: 8px; cursor: pointer; padding: 8px; border-radius: 4px; transition: background-color 0.2s;" 
                                    ...
                                    <input type="checkbox" 
                                           ...
                                           value="{{ $lab->id }}"
                                           {{ in_array($lab->id, old('laboratorium_ids', $selectedLabIds ?? [])) ? 'checked' : '' }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="Nama_Laboran" id="Nama_Laboran" class="form-control"
                               value="{{ old('Nama_Laboran', $laboran->Nama_Laboran) }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" name="Phone" id="Phone" class="form-control"
                               value="{{ old('Phone', $laboran->Phone) }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="Email" id="Email" class="form-control"
                               value="{{ old('Email', $laboran->Email) }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <p class="form-hint">Akun ini dikhususkan untuk role Laboran</p>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-primary btn-sm">Update Data Laboran</button>
                </div>
            </form>
        </div>
    </div>
